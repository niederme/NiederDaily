...
def test_nyt_block_returns_top_5(requests_mock):
    requests_mock.get("https://api.nytimes.com/svc/mostpopular/v2/emailed/1.json", json=NYT_RESPONSE)
...
def test_nyt_block_returns_none_on_api_error(requests_mock):
    requests_mock.get("https://api.nytimes.com/svc/mostpopular/v2/emailed/1.json", status_code=429)
    result = nyt_block("test-key")
